      ...
      <section className="rounded-2xl border border-border bg-surface p-6">
        <div className="space-y-2">
          ...
          <p className="max-w-3xl text-sm text-muted-foreground">
            O OpenArtDesk salva seus dados localmente no seu computador. Preferências
            visuais ficam em JSON local, dados estruturados ficam em SQLite e arquivos
            grandes serão salvos no sistema de arquivos local.
          </p>
        </div>
      </section>
